package com.Base.dndcharactersheet.Fragments.PopupFragments.Journal;
...
public class JournalEntryFragment extends FragmentBase {
    ...
    public JournalEntryFragment(MainActivity parent, JournalFragment journalView){
        super(R.layout.fragment_journal_journalentry,parent);
    ...
    public android.view.View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View journalEntryVar = inflater.inflate(R.layout.fragment_journal_journalentry,container,false);
